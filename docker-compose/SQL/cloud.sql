...
VALUES ('client_id', NULL, '$2a$10$MIMYGgJDTPAKmaULX/0vYe/J5PvfoOdJHSil6uNTx1LKslKnGDQGC', 'read',
        'client_credentials,authorization_code,mobile,password,refresh_token', 'http://baidu.com', NULL, 7200, 108000,
        NULL, NULL);
...
(
    ...
    `filters`     varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
    `modify_time` datetime(0) NULL DEFAULT NULL,
    `orders`      int(0) NULL DEFAULT NULL,
    `predicates`  varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
    `status`      varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
    `uri`         varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
VALUES ('authentication-service', '2021-03-20 11:51:08', NULL, '[]', '2021-03-20 11:51:08', 0,
        '[{\"name\":\"Path\",\"args\":{\"pattern\":\"/authentication/**\"}}]', 'Y', 'lb://authentication-service', 0);
INSERT INTO `tb_gateway_route`
VALUES ('authorization-service', '2021-03-20 11:51:08', NULL, '[]', '2021-03-20 11:51:08', 0,
        '[{\"name\":\"Path\",\"args\":{\"pattern\":\"/authorization/**\"}}]', 'Y', 'lb://authorization-service', 0);
...
-- 角色和资源关系表
DROP TABLE IF EXISTS tb_role_resource_relation;
...
-- 资源
INSERT INTO tb_resource (id, name, code, type, url, method, description, created_time, updated_time, created_by, updated_by)
...
-- 用户关系授权
INSERT INTO tb_user_role_relation (id, user_id, role_id, created_time, updated_time, created_by, updated_by)
VALUES (101, 101, 101, now(), now(), 'system', 'system'),
       (102, 102, 101, now(), now(), 'system', 'system'),
       (103, 102, 103, now(), now(), 'system', 'system');
-- 角色与资源关系表
INSERT INTO tb_role_resource_relation (id, role_id, resource_id, created_time, updated_time, created_by, updated_by)
VALUES (101, 101, 101, now(), now(), 'system', 'system'),
...
-- 菜单
INSERT INTO tb_menu (id, parent_id, type, href, icon, name, description, order_num, created_time, updated_time, created_by, updated_by)
...
-- 角色关系表
INSERT INTO tb_role_menu_relation (id, role_id, menu_id, created_time, updated_time, created_by, updated_by)
VALUES (101, 101, 101, now(), now(), 'system', 'system'),
       (102, 101, 102, now(), now(), 'system', 'system'),
       (103, 101, 103, now(), now(), 'system', 'system'),
